...
from dataload_rarp_resnet import CustomVideoDatasetGesture
# ----------------------------
# Model Definition
# ----------------------------
class ResNetMultiClass(nn.Module):
    def __init__(self, resnet_type="resnet50", pretrained=True, num_classes=8):
...
if __name__ == "__main__":
    ...
    train_dataset = CustomVideoDatasetGesture(mode="train", transform=train_transform)
    test_dataset  = CustomVideoDatasetGesture(mode="test",  transform=test_transform)
    ...
    class_weight = torch.tensor([6.44080604534005,16.889035667107002, 4.06130876747141, 4.054868379321281, 4.6038890889449045, 61.76328502415459, 43.04713804713805, 27.733188720173537], dtype=torch.float).to(device)
    ...
    for epoch in range(num_epochs):
        ...
        # --- TRAIN ---
        train_f1, train_acc, train_loss = train(model, train_loader, criterion, optimizer, device)
